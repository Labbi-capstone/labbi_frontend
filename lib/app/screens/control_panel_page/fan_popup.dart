...
class FanPopup extends StatefulWidget {
  final double currentValue;
  const FanPopup({super.key, required this.currentValue});
  @override
  State<StatefulWidget> createState() => _FanPopupState();
}

class _FanPopupState extends State<FanPopup> {
