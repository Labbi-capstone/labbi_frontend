                      ...
                      child: TextButton.icon(
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    const AdminOrgHomePage()), // Replace with the appropriate screen for managing users
                          );
                        },
                      ...
                      child: TextButton.icon(
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    const AdminDeviceHistoryPage()), // Replace with the appropriate screen for viewing reports
                          );
                        },
